...
<div class="container-fluid px-0 wow fadeIn" data-wow-delay="0.1s" style="background-color: #830000 ;">
  <div class="row gx-0 align-items-center d-none d-lg-flex">
    <div class="col-lg-6 px-5 text-start">
      <ol class="breadcrumb mb-0">
        <li class="breadcrumb-item"><a class="small text-white" href="#">Home</a></li>
        <li class="breadcrumb-item"><a class="small text-white" href="#">Career</a></li>
        <li class="breadcrumb-item"><a class="small text-white" href="#">Terms</a></li>
        <li class="breadcrumb-item"><a class="small text-white" href="#">Privacy</a></li>
      </ol>
    </div>
    <div class="col-lg-6 px-5 text-end text-white "> <small>Follow us:</small>
      <div class="h-100 d-inline-flex align-items-center"> <a class="btn-square text-white border-end rounded-0" href=""><i class="fab fa-facebook-f"></i></a> <a class="btn-square text-white border-end rounded-0" href=""><i class="fab fa-twitter"></i></a> <a class="btn-square text-white border-end rounded-0" href=""><i class="fab fa-linkedin-in"></i></a> <a class="btn-square text-white pe-0" href=""><i class="fab fa-instagram"></i></a> </div>
    </div>
  </div>
</div>
<!-- Topbar End --> 
