						...
						<div class="course-item bg-light">
							<div class="position-relative overflow-hidden text-center shadow">
								...
								<div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
									<a href="<?= site_url('artikel/' . buat_slug($article)) ?>" class="flex-shrink-0 btn btn-sm btn-danger px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
									<a href="<?= site_url('artikel/' . buat_slug($article)) ?>" class="flex-shrink-0 btn btn-sm btn-danger px-3" style="border-radius: 0 30px 30px 0;">Join Now</a>
								</div>
							</div>
							...
							<div class="d-flex border-top">
								...
								<small class="flex-fill text-center py-2"><i class="fa fa-user text-danger me-2"></i><?= $article['hit'] ?></small>
							</div>
						</div>
					</div>
