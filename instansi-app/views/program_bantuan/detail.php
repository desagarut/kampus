...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h4 class="m-0">Program Bantuan: <?= $detail['nama']; ?></h4>
				</div>
				<!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="<?= site_url('beranda') ?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item"><a href="<?= site_url('program_bantuan') ?>"> Daftar Program Bantuan</a></li>
						<li class="breadcrumb-item active">Program Bantuan <?= $detail['nama']; ?></li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
							...
							<?php if ($detail["status"] == 1) : ?>
								<div class="btn-group btn-group-vertical">
									...
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="<?= site_url("program_bantuan/aksi/1/" . $detail['id']) ?>" class="btn btn-box btn-block btn-sm" title="Tambah Satu Peserta Baru "><i class="fa fa-plus"></i> Tambah Satu Peserta Baru</a>
										</li>
										<li>
											<a href="<?= site_url("program_bantuan/aksi/2/" . $detail['id']) ?>" class="btn btn-box btn-block btn-sm" title="Tambah Beberapa Peserta Baru"><i class="fa fa-plus"></i> Tambah Beberapa Peserta Baru</a>
										</li>
									</ul>
								</div>
							<?php endif; ?>
							<a href="#confirm-delete" title="Hapus Data Terpilih" onclick="deleteAllBox('mainform', '<?= site_url("program_bantuan/delete_all/$detail[id]") ?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash'></i> Hapus Data Terpilih</a>
						...
						<div class="card-body">
							<div class="row">
								<div class="col-sm-12">
									...
									<?php include('instansi-app/views/program_bantuan/rincian.php'); ?>
																...
																<?php foreach ($peserta as $key => $item) : ?>
																	<tr>
																		...
																		<td class="padat">
																			...
																			<a href="#" data-href="<?= site_url("program_bantuan/hapus_peserta/$detail[id]/$item[id]") ?>" class="btn bg-maroon btn-box btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																		</td>
