			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item"><a href="<?= site_url("program_bantuan/detail/$detail[id]") ?>"> Rincian Program Bantuan</a></li>
						...
						<div class="card-body">
							<div class="row">
								<div class="col-sm-12">
											...
											<div class="row">
												<div class="col-sm-6">
													<div class="card-info box-solid">
														...
														<div class="card-body">
															<?php include('instansi-app/views/program_bantuan/konfirmasi_peserta.php'); ?>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="col-sm-6">
										<div class="card card-success box-solid">
											<div class="card-header">
