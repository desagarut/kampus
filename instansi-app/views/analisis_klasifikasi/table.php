...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Pengaturan Klasifikasi - <?= $analisis_master['nama']?></h5>
		<ul class="breadcrumb">
			...
			<li><a href="<?= site_url() ?>analisis_klasifikasi/leave"><?= $analisis_master['nama']?></a></li>
						<li class="breadcrumb-item active">Pengaturan Klasifikasi</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
	...
	<div class="card">
		<form id="mainform" name="mainform" action="" method="post">
            ...
            <div class="card-header">
							<a href="<?= site_url('analisis_klasifikasi/form') ?>" class="btn btn-box btn-success btn-sm " title="Tambah Klasifikasi Baru" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Tambah Klasifikasi Baru"><i class="fa fa-plus"></i> Tambah Klasifikasi Baru</a>
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("analisis_klasifikasi/delete_all/$p/$o") ?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash'></i> Hapus Data Terpilih</a>
							<a href="<?= site_url() ?>analisis_klasifikasi/leave" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left "></i> Kembali Ke <?= $analisis_master['nama']?></a>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-sm-12">
																...
																<?php foreach ($main as $data): ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<a href="#" data-href="<?= site_url("analisis_klasifikasi/delete/$p/$o/$data[id]") ?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																		</td>
