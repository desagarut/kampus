...
<footer class="main-footer">
	...
	<span class="logo-mini logo-text" style="padding-top:7px"><img src="<?= gambar_institusi($desa['logo']); ?>" class="img-logo" alt="User Image" width="30px"></span> <a href="#" target="_blank"></a> Sistem Informasi <?= $this->setting->website_title ?><strong><a href="#" target="_blank"></a>.</strong>
</footer>
