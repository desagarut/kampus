<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Profil Desa</h5>
		<ul class="breadcrumb">
			...
			<div class="row">
				...
				<div class="col-md-8 col-lg-9">
						...
						<div class="card-header">
							<a href="<?= site_url('potensi_umum/form') ?>" class="btn btn-box btn-success btn-sm btn-sm " title="Tambah Data Baru">
				...
				},
				{
					'data': function(data) {
						...
						return `
							...
							${status}
							<a href="#" data-href="<?= site_url('potensi_umum/delete/'); ?>${data.id}" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>							`
					}
				},
				{
					'data': 'bulan_laporan'
