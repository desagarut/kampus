...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Pendataan Peserta Vaksin Covid19</h5>
		<ul class="breadcrumb">
			<li><a href="<?= site_url('beranda')?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item active">Data Peserta Vaksin Covid19</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="card-header">
						<a href="<?= site_url("covid19_vaksin/form_peserta_vaksin")?>" title="Tambah Data Warga" class="btn btn-box bg-olive btn-sm "><i class="fa fa-plus"></i> Tambah Data Warga Vaksin</a>
						<a href="<?= site_url("covid19_vaksin/daftar/cetak")?>" class="btn btn-box bg-purple btn-sm " title="Cetak" target="_blank"><i class="fa fa-print"></i> Cetak
						</a>
						<a href="<?= site_url("covid19_vaksin/daftar/unduh")?>" class="btn btn-box bg-navy btn-sm " title="Unduh" target="_blank"><i class="fa fa-download"></i> Unduh
						</a>
					</div>
					<div class="card-body">
						<div class="row">
														...
														<tbody>
															...
															<tr>
																...
																<td nowrap>
																		...
																		<a href="#" data-href="<?= site_url('covid19_vaksin/hapus_peserta_vaksin/'.$item[id])?>" class="btn bg-maroon btn-box btn-sm" title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
						<a href="<?= site_url('covid19_vaksin/detil_peserta_vaksin/'.$item[id])?>" title="Detil Data Warga" class="btn btn-box bg-olive btn-sm "><i class="fa fa-eye"></i></a>
																</td>
