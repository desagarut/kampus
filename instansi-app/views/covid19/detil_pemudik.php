    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="card-header">
            <a href="<?= site_url('covid19')?>" class="btn btn-box btn-info btn-sm "><i class="fa fa-arrow-circle-left"></i> Kembali Ke Data Pemudik</a>
            <?php if ($penduduk['id_status'] === '2' OR $penduduk['id_status'] === '3'): ?>
              <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit-warga">
                ...
                Ubah Data Kependudukan Non Domisili
              </a>
            <?php endif ?>
          </div>

          <div class="card-header">
            <h3 class="card-title">Detil Pemudik</h3>
          </div>
