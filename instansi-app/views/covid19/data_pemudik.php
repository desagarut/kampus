															...
															<tr>
																...
																<td nowrap>
																	<?php if ($this->CI->cek_hak_akses('h')): ?>
																		...
																		<a href="#" data-href="<?= site_url("covid19/hapus_pemudik/$item[id]")?>" class="btn bg-maroon btn-box btn-sm" title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																	<?php endif; ?>
																</td>
