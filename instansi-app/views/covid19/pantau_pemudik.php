		...
		<div class="row">
			<div class="col-md-3">
					...
					<div class="card-header">
						<h3 class="card-title"><strong>Form Pemantauan</strong></h3>
					</div>
					<div class="card-body">
														...
														<tbody>
															...
															<tr>
																...
																<td nowrap>
																	...
																	<a href="#" data-href="<?= site_url("$url_delete_front/$item[id]/$url_delete_rare")?>" class="btn bg-maroon btn-box btn-sm" title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>																	<?php endif; ?>
																</td>
