<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Penambahan Pemudik Covid-19</h5>
		<ul class="breadcrumb">
		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="card-header">
						<div class="col-md-12">
							<a href="<?= site_url('covid19')?>" class="btn btn-box btn-primary btn-sm " title="Kembali Ke Daftar Pemudik Saat Covid-19"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Pemudik Saat Covid-19</a>
						</div>
					</div>
					<div class="card-body">
						<div class="row">
								...
								<div class="card-body">
									...
									<div id="form-melengkapi-data-peserta">
										<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
											...
											<?php if ($individu): ?>
												<?php include("instansi-app/views/covid19/konfirmasi_pemudik.php"); ?>
											<?php endif; ?>

											<?php include("instansi-app/views/covid19/form_isian_pemudik.php"); ?>
	...
	<div class='modal-dialog'>
		<div class='modal-content'>
			...
			<div class='modal-body'>
				<div class="row">
					<?php include("instansi-app/views/covid19/form_isian_penduduk.php"); ?>
				</div>
			</div>
