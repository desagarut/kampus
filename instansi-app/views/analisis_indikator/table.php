            ...
            <div class="card-header">
							...
							<?php if ($analisis_master['lock']==1): ?>
								...
								<a href="#confirm-delete" title="Hapus Data"
									...
									class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash'></i> Hapus Data Terpilih</a>
																		...
																		<?php if ($analisis_master['lock']==1): ?>
																			...
																			<td nowrap>
																				...
																				<?php if ($analisis_master['jenis']!=1): ?>
																					...
																					<a href="#" data-href="<?= site_url("analisis_indikator/delete/$p/$o/$data[id]")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
