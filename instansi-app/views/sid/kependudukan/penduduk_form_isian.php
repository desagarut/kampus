...
<div class="col-md-9">
	<div class='card card-primary'>
		<div class="card-header">
			<a href="<?=site_url('penduduk/clear')?>" class="btn btn-social btn-box btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Data Kependudukan"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Penduduk</a>
		</div>
		<div class='card-body'>
