			...
			<div class="row">
							...
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<tr>
										...
										<td>
										 <select name="ktp_el" class="form-control form-control-sm input-sm">
										...
										<td width='25%'>
										 <select name="status_rekam" class="form-control form-control-sm input-sm">
										...
										<td width='25%'>
										 <input name="tag_id_card" class="form-control form-control-sm  input-sm digits" type="text" minlength="10" maxlength="15" placeholder="Tag Id Card" value="<?= $penduduk['tag_id_card']?>"></input>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<input id="no_kk_sebelumnya" name="no_kk_sebelumnya" class="form-control form-control-sm input-sm nik" maxlength="30" type="text" placeholder="No KK Sebelumnya" value="<?= strtoupper($penduduk['no_kk_sebelumnya'])?>"></input>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm input-sm <?= jecho($id_kk, true, 'required'); ?>" name="kk_level">
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<input id="akta_lahir" name="akta_lahir" class="form-control form-control-sm  input-sm nomor_sk" type="text" maxlength="40" placeholder="Nomor Akta Kelahiran" value="<?= $penduduk['akta_lahir']?>"></input>
					</div>
				</div>
				<div class='col-sm-8'>
					<div class='form-group'>
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm  input-sm pull-right" id="jammenit_1" name="waktu_lahir" type="text" value="<?= $penduduk['waktu_lahir']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm  input-sm" name="tempat_dilahirkan">
					...
					<div class="row">
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<select class="form-control form-control-sm  input-sm" name="jenis_kelahiran">
						...
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<input id="kelahiran_anak_ke" name="kelahiran_anak_ke" class="form-control form-control-sm  input-sm number" maxlength="2" type="text" placeholder="Anak Ke" value="<?= strtoupper($penduduk['kelahiran_anak_ke'])?>"></input>
							</div>
						</div>
						<div class='col-sm-4'>
							<div class='form-group'>
								<label for="penolong_kelahiran">Penolong Kelahiran</label>
								<select class="form-control form-control-sm  input-sm" name="penolong_kelahiran">
					...
					<div class="row">
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<input id="berat_lahir" name="berat_lahir" class="form-control form-control-sm  input-sm number" maxlength="6" type="text" placeholder="Berat Lahir" value="<?= strtoupper($penduduk['berat_lahir'])?>"></input>
							</div>
						</div>
						<div class='col-sm-4'>
							<div class='form-group'>
								<label for="panjang_lahir">Panjang Lahir <code>( cm )</code></label>
								<input id="panjang_lahir" name="panjang_lahir" class="form-control form-control-sm  input-sm number" maxlength="3" type="text" placeholder="Panjang Lahir" value="<?= strtoupper($penduduk['panjang_lahir'])?>"></input>
							</div>
						</div>
					</div>
				</div>
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm  input-sm required" name="pendidikan_kk_id">
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm  input-sm" name="pendidikan_sedang_id" >
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm  input-sm required" name="warganegara_id">
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm  input-sm pull-right" id="tgl_2" name="tanggal_akhir_paspor" type="text" value="<?= $penduduk['tanggal_akhir_paspor']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-8'>
					<div class='form-group'>
						...
						<input id="dokumen_kitas" name="dokumen_kitas" class="form-control form-control-sm  input-sm number" maxlength="10" type="text" placeholder="Nomor KITAS/KITAP" value="<?= strtoupper($penduduk['dokumen_kitas'])?>"></input>
					</div>
				</div>
				<div class='col-sm-12'>
					<div class="form-group subtitle_head">
					...
					<div class="row">
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<input id="ayah_nik" name="ayah_nik" class="form-control form-control-sm  input-sm nik" type="text" placeholder="Nomor NIK Ayah" value="<?= $penduduk['ayah_nik']?>"></input>
							</div>
						</div>
						<div class='col-sm-8'>
							<div class='form-group'>
								<label for="nama_ayah">Nama Ayah </label>
								<input id="nama_ayah" name="nama_ayah" class="form-control form-control-sm  input-sm required nama" maxlength="100" type="text" placeholder="Nama Ayah" value="<?= strtoupper($penduduk['nama_ayah'])?>"></input>
							</div>
						</div>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<input id="ibu_nik" name="ibu_nik" class="form-control form-control-sm  input-sm nik" type="text" placeholder="Nomor NIK Ibu" value="<?= $penduduk['ibu_nik']?>"></input>
					</div>
				</div>
				<div class='col-sm-8'>
					<div class='form-group'>
						<label for="nama_ibu">Nama Ibu </label>
						<input id="nama_ibu" name="nama_ibu" class="form-control form-control-sm  input-sm required nama" maxlength="100" type="text" placeholder="Nama Ibu" value="<?= strtoupper($penduduk['nama_ibu'])?>"></input>
					</div>
				</div>
				<div class='col-sm-12'>
					<div class="form-group subtitle_head">
				...
				<div class='col-sm-12'>
					<div class='form-group'>
						...
						<input id="telepon" name="telepon" class="form-control form-control-sm  input-sm" type="text" placeholder="Nomor Telepon" size="20" value="<?= $penduduk['telepon']?>"></input>
					</div>
				</div>
					<div class='col-sm-12'>
					<div class='form-group'>
				...
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<?php endif; ?>
							<input id="akta_perkawinan" name="akta_perkawinan" class="form-control form-control-sm  input-sm nomor_sk" type="text" maxlength="40" placeholder="Nomor Akta Perkawinan" value="<?= $penduduk['akta_perkawinan']?>"></input>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm  input-sm pull-right" id="tgl_3" name="tanggalperkawinan" type="text" value="<?= $penduduk['tanggalperkawinan']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-8'>
					<div class='form-group'>
						...
						<input id="akta_perceraian" name="akta_perceraian" class="form-control form-control-sm  input-sm nomor_sk" maxlength="40" type="text" placeholder="Akta Perceraian" value="<?= strtoupper($penduduk['akta_perceraian'])?>"></input>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class='form-group'>
						...
						<div class="input-group input-group-sm date">
							...
							<input class="form-control form-control-sm  input-sm pull-right" id="tgl_4" name="tanggalperceraian" type="text" value="<?= $penduduk['tanggalperceraian']?>">
						</div>
					</div>
				</div>
				<div class='col-sm-12'>
					...
					<div class="row">
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<select class="form-control form-control-sm  input-sm required" name="golongan_darah_id">
						...
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<select class="form-control form-control-sm  input-sm" name="cacat_id" >
						...
						<div class='col-sm-4'>
							<div class='form-group'>
								...
								<select class="form-control form-control-sm  input-sm" name="sakit_menahun_id">
				...
				<div class='col-sm-4' id="akseptor_kb">
					<div class='form-group'>
						...
						<select class="form-control form-control-sm  input-sm" name="cara_kb_id" >
				...
				<div id='isian_hamil' class='col-sm-4'>
					<div class='form-group'>
						...
						<select class="form-control form-control-sm  input-sm" name="hamil">
