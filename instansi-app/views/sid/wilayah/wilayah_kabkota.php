										...
										<tbody>
											...
											?>
												<tr>
													...
													<td nowrap>
														<a href="<?= site_url("sid_core/sub_kecamatan/$id_provinsi/$data[id]") ?>" class="btn bg-purple btn-box btn-sm" title="Rincian Sub Wilayah"><i class="fa fa-search"></i> Kecamatan</a>
														<?php if ($this->CI->cek_hak_akses('h')) : ?>
