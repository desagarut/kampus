...
<div class="pcoded-main-container">
	...
	<div class="page-header">
		<h5 class="m-b-10">Rincian Mutasi Letter-C</h5>
		<ul class="breadcrumb">
			...
			<li><a href="<?= site_url('letterc/rincian/'.$letterc[id])?>"> Rincian Letter-C</a></li>
						<li class="breadcrumb-item active">Mutasi Letter-C</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="card-header">
						<a href="<?=site_url("letterc/create_mutasi/".$letterc['id'])."/".$persil['id']?>" class="btn btn-box btn-success btn-sm btn-sm "  title="Tambah Persil">
							<i class="fa fa-plus"></i>Tambah Mutasi Persil
						</a>
						<a href="<?=site_url('letterc')?>" class="btn btn-box btn-primary btn-sm " title="Kembali Ke Daftar Letter-C"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Letter-C</a>
						</a>
						<a href="<?=site_url('letterc/rincian/'.$letterc[id])?>" class="btn btn-box btn-info btn-sm " title="Kembali Ke Daftar Letter-C"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Rincian Letter-C</a>
						</a>
					</div>
					<div class="card-body">
						<div class="row">
								...
								<div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
									<form id="mainform" name="mainform" action="" method="post">
										...
										<div class="row">
											<div class="col-sm-12">
												<div class="card-header">
													<h3 class="card-title">Rincian Letter-C</h3>
												</div>
												<div class="card-body">
											...
											<div class="col-sm-12">
												<div class="row">
													<div class="col-sm-9">
														<div class="card-header">
															<h3 class="card-title">Daftar Mutasi Persil <?= $persil["nomor"]?></h3>
														</div>
													</div>
												</div>
											</div>
																...
																<tr>
																	...
																	<td nowrap class="text-center">
																		...
																		<?php if ($item['jenis_mutasi'] != '9'): ?>
																			<a href="#" data-href="<?= site_url("letterc/hapus_mutasi/$letterc[id]/$item[id]")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																		<?php else: ?>
																			<a href="#" data-href="<?= site_url('letterc/awal_persil/'.$letterc['id'].'/' .$persil['id'].'/1')?>" class="btn bg-maroon btn-box btn-sm"  title="Bukan pemilik awal" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																		<?php endif; ?>
																	</td>
							...
							<div class='modal-dialog'>
								<div class='modal-content'>
									...
									<div class='modal-footer'>
										...
										<a class='btn-ok'>
											<button type="button" class="btn btn-box btn-danger btn-sm" id="ok-delete"><i class='fa fa-trash'></i> Hapus</button>
										</a>
									</div>
								</div>
							</div>
