					...
					<div class="col-md-4">
						<div class="card-body">
							<div class="brand-wrapper" align="center">
								<a href="<?= site_url('first'); ?>"><img src="<?= gambar_institusi($header['logo']); ?>" alt="<?= $header['nama_kecamatan'] ?>" class="img-responsive" style="max-width: 80px; max-height: 80px" /></a>
							</div>
							<h1 align="center" style="font-size:18px"><strong>LOGIN</strong> <br/><?= strtoupper($this->setting->sebutan_pt) ?> <?= strtoupper($header['nama_instansi']) ?></h4>
			...
			<div class="card login-card">
				<div class="card-header">
					<div class="row">
						...
						Sistem Informasi <a href="https://garutkab.go.id" target="_blank"><?= $header['nama_instansi'] ?></a> | 2022 
						</div>
					</div>
				</div>
			</div>
