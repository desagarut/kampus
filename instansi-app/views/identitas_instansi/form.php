				...
				<form id="mainform" action="<?= $form_action; ?>" method="POST" enctype="multipart/form-data" class="form-horizontal" id="validasi">
					<div class="row">
						<div class="col-lg-3 col-md-12">
							...
							<!--<div class="card">
								<div class="card-body">
									<img class="img-fluid card-img-top" src="<?= gambar_institusi($main['kantor_kecamatan'], TRUE); ?>" alt="Kantor <?= $kecamatan; ?>">
									<br />
						...
						<div class="col-lg-9 col-md-12">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										<label class="col-sm-3 col-form-label" for="nama_pimpinan">Nama Pimpinan</label>
										<div class="col-sm-9">
