	...
	<div class="page-header">
		...
		<ul class="breadcrumb">
			<li><a href="<?=site_url('beranda'); ?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item active">Resume Statistik <?= $dusun; ?></li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
                        ...
                        <div class='card-body'>
                            <div class="col-sm-2 col-xs-6">
                                <div class="small-box bg-purple">
                                    ...
                                    <a href="<?=site_url('sid_core')?>" class="small-card-footer">Detail  <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <div class="small-box bg-aqua">
                                    ...
                                    <a href="<?=site_url('penduduk/clear')?>" class="small-card-footer">Detail  <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <div class="small-box bg-green">
                                    ...
                                    <a href="<?=site_url('keluarga/clear')?>" class="small-card-footer">Detail  <i class="fa fa-arrow-circle-right"></i></a>
                            ...
                            <div class="col-sm-2 col-xs-6">
                                <div class="small-box bg-red">
                                    ...
                                    <a href="<?=site_url('kelompok/clear')?>" class="small-card-footer">Detail  <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <div class="col-sm-2 col-xs-6">
                                <div class="small-box bg-orange">
                                    ...
                                    <a href="<?=site_url('rtm/clear')?>" class="small-card-footer">Detail  <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
					</div>
